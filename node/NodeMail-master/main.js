...
//纪念日
let startDay = "2019/4/25";
//当地拼音,需要在下面的墨迹天气url确认
const local = "anhui/qiaocheng-district";

//发送者邮箱厂家
let EmianService = "qq";
//发送者邮箱账户SMTP授权码
let EamilAuth = {
  user: "1360924711@qq.com",
  pass: "glhtpdjifnyjgeeb"
};
//发送者昵称与邮箱地址
let EmailFrom = '"一只大笨狗" <1360924711@qq.com>';

//接收者邮箱地
let EmailTo = "1360924711@qq.com";
//邮件主题
let EmailSubject = "给大美妞的暖暖的邮件呀";

//每日发送时间
let EmailHour = 14;
let EmialMinminute= 41;
