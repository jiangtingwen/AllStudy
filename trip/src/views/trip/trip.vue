...
<div class="trip">
    ...
    <md-tabs v-model="TripWay">
      <md-tab-pane name="徒步" label="徒步">
      </md-tab-pane>
      <md-tab-pane  name="跑步" label="跑步">
      </md-tab-pane>
      <md-tab-pane  name="骑行" label="骑行">
      </md-tab-pane>
      <md-tab-pane  name="自驾" label="自驾">
      </md-tab-pane>
    </md-tabs>
...
export default {
    ...
    methods:{
        tripStartOnclick () {
            this.$router.push({name:'Map',params:{tripTypes:this.TripWay}})
        }
    }
